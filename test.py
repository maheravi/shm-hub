...
Usage: 
      python test.py --data_path ../datasets/crack/val --resume output/checkpoint.pth
...
from datasets.crack import make_crack_transforms
...
def infer(images_path, model, postprocessors, device, output_path):
    ...
    for img_sample in images_path:
        ...
        w, h = orig_image.size
        transform = make_crack_transforms("val")
        dummy_target = {

...
* Fine Tuning: https://github.com/tahmid0007/DETR_FineTune
...
```
../datasets/crack_detection/
  coco_annotations_train.json 
  coco_annotation_val.json  
  train/    # train images
  val/      # val images
  
# Download crack_detection dataset:
run
$ bash ./datasets/get_crack_data.sh
